...
[`EnsureIndexes`](../../internal/config/database.go).
...
| Field | Notes |
|---|---|
| `kind` | One of the 20 values in [`models.AllCatalogKinds`](../../internal/models/models.go). |
...
[`NewGeoPoint(lat, lng)`](../../internal/models/models.go) takes
...
([guard.go](../../internal/config/guard.go)):
...
[`guard_test.go`](../../internal/config/guard_test.go).

The seed loader ([`cmd/seed`](../../cmd/seed/main.go)) adds a
